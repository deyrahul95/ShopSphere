...
public class DebitCardPaymentProvider(ILogger<DebitCardPaymentProvider> logger) : IPaymentProvider
{
    private readonly PaymentMode _paymentMode = PaymentMode.DebitCard;
